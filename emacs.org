...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-after-load "hl-line"
    '(progn
       ...
       (advice-add 'counsel-describe-face :before #'my-describe-face)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package ledger-mode
    ...
    (add-to-list 'ledger-reports
                 '("month" "./bin/run-reports"))
    (add-to-list 'ledger-reports
                 '("mtd" "./bin/run-reports -mtd"))
    (add-to-list 'ledger-reports
                 '("reimbursements" "./bin/invoice-reimbursements"))
